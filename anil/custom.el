...
(custom-set-variables
 ...
 '(default-frame-alist (quote ((font . "-apple-inconsolata-medium-r-normal--20-180-72-72-m-180-iso10646-1") (tool-bar-lines . 0) (vertical-scroll-bars) (background-color . "#141414") (background-mode . dark) (border-color . "black") (cursor-color . "#A7A7A7") (foreground-color . "#F8F8F8") (mouse-color . "sienna1"))))
